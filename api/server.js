        ...
        messages: [
          {
            ...
            content:
              ...
              "Проаналізуй саме комерційний сенс конкретної заявки, а не переказуй усі отримані цифри. " +
              "Спочатку визнач головний сценарій: хороший баланс ціни й маржі; " +
              "конкурентна ціна, але слабка маржа; достатня маржа, але завищена роздрібна ціна; " +
              "потрібна дешевша закупка; широкий або суперечливий діапазон ринкових цін; " +
              "або недостатньо даних. Побудуй висновок навколо головного сценарію " +
              "і, за потреби, одного додаткового фактора. " +
              "Не використовуй універсальний шаблон, однаковий вступ, однаковий порядок показників " +
              "та однакове завершення. Цифри використовуй вибірково — лише ті, що справді пояснюють рішення. " +
              "Напиши українською 3–5 природних речень суцільним текстом. " +
              "Висновок повинен містити практичне рішення, його причину та одну конкретну наступну дію. " +
              "Якщо для конкурентної ціни потрібна нижча закупка, назви розраховану максимальну закупівельну ціну. " +
              "Не вигадуй попит, продажі, якість товару, умови постачання або надійність постачальника. " +
              "Не згадуй дату перевірки, назви джерел, технічні поля чи отриману форму подачі."
          },
          {
            role: "user",
            content: JSON.stringify({
              ...
              metricMeaning: {
                plannedMarginPercent:
                  "Валова маржа за введеними закупівельною та плановою роздрібною цінами.",
                marginAtMarketMedianPercent:
                  "Валова маржа, якщо продавати за медіанною ціною ринку.",
                plannedPriceVsMedianPercent:
                  "Відхилення планової роздрібної ціни від медіани ринку.",
                maxPurchaseAtMarketMedian:
                  "Максимальна закупівельна ціна біля медіани ринку для збереження запланованої маржі.",
                requiredPurchaseReduction:
                  "На скільки потрібно знизити закупівельну ціну."
              }
            })
          }
        ]
